...
# Set your HuggingFace token - replace with your actual token or use HF_TOKEN environment variable
...
def preprocess_function(example, tokenizer, max_length=1024):  # Adjust max_length as needed
